                        ...
                        <form action="{{ route('artikel.update', $artikel->id) }}" method="post"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="body" id="body" required>{{ $artikel->body }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('uploads/' . $artikel->gambar_artikel) }}" style="max-width: 200px; max-height: 200px;" alt="">
                                </div>
                            </div>
