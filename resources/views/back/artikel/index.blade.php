                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ route('artikel.create') }}" class="btn btn-primary btn-round btn-sm ml-auto">
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        <th class="sorting_asc" tabindex="0" aria-controls="add-row"
                                                            ...
                                                            style="width: 193.891px;">Judul Artikel</th>
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="add-row"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Slug: activate to sort column ascending"
                                                            style="width: 283.703px;">Kategori</th>
                                                        <th class="sorting" tabindex="0" aria-controls="add-row"
                                                            rowspan="1" colspan="1"
                                                            aria-label="Slug: activate to sort column ascending"
                                                ...
                                                <tbody>
                                                    @forelse ($artikel as $key => $row)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div>
                                                                    <img src="{{ asset('uploads/' . $row->gambar_artikel) }}" alt="{{ $row->judul }}" style="max-width: 100px; max-height: 100px;">
                                                                </div>  
                                                            </td>
                                                            <td>
                                                                <div class="form-button-action">
                                                                    <a href="{{ route('artikel.edit', $row->id) }}" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit artikel">
                                                                        <i class="fa fa-edit"></i>
                                                                    </a>
                                                                    <form action="{{ route('artikel.destroy', $row->id) }}" method="post" onsubmit="return confirmDelete()">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button type="submit" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Delete artikel">
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td class="text-center bg-warning font-weight-bold"
                                                                style="font-size: 20px" colspan="6">Data masih kosong
                                                            </td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
