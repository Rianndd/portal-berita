                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Edit Playlist {{ $playlist->judul_playlist }}</h4>
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="judul_playlist"
                                        value="{{ $playlist->judul_playlist }}"  required>
                                </div>
                                <div class="form-group">
                                    <label for="body">Deskripsi</label>
                                    <textarea class="form-control" name="deskripsi" id="editor">{{ $playlist->deskripsi }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="gambar_artikel">Gambar Playlist</label>
                                    <input type="file" class="form-control" name="gambar_playlist" id="gambar_artikel">
                                    <label for="gambar_artikel">Gambar Sekarang</label> <br>
                                    <img src="{{ asset('uploads/' . $playlist->gambar_playlist) }}" style="max-width: 200px; max-height: 200px;" alt="">
                                </div>
                                <div class="form-group">
